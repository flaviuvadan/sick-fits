...
})(["position:relative;.count{display:block;position:relative;transition:all 1s;backface-visibility:hidden;}.count-enter{position:absolute;transform:rotateX(0.5turn);}.count-enter-active{position:absolute;transform:rotateX(0);}count-exit{top:0;position:absolute;transform:rotateX(0);}.count-exit-active{position:absolute;transform:rotateX(0.5turn);}"]);
...
//# sourceMappingURL=_app.js.d67ddbec1ecedd90636a.hot-update.js.map