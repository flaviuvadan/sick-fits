...
})(["position:relative;.count{display:block;position:relative;transition:all 1s;backface-visibility:hidden;}.count-enter{transform:rotateX(0.5turn);}.count-enter-active{transform:rotateX(0);}count-exit{top:0;position:absolute;transform:rotateX(0);}.count-exit-active{position:absolute;transform:rotateX(0.5turn);}"]);
...
//# sourceMappingURL=_app.js.cefa3395e0ea59d6a4f1.hot-update.js.map